...
pub struct BehaviorHostInput {
    ...
    pub drone_can_move: bool,
    pub drone_can_return_to_port: bool,
    pub drone_can_work: bool,
    pub drone_can_idle: bool,
    pub drone_cargo_free: i32,
    pub drone_cargo_counts: BTreeMap<ItemKind, i32>,
    pub drone_contact_inventory_counts: BTreeMap<ItemKind, i32>,
    pub drone_contact_space_counts: BTreeMap<ItemKind, i32>,
