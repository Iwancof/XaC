...
const ALL_BEHAVIOR_KINDS: &[BehaviorKind] = &[
    BehaviorKind::Drill,
    BehaviorKind::Router,
...
impl HostImportSpec {
    fn allowed_for(self, kind: BehaviorKind) -> bool {
        self.kinds.contains(&kind)
    }
}

const HOST_IMPORT_SPECS: &[HostImportSpec] = &[
    HostImportSpec {
        module: "xac:common",
        name: "log",
        wit_name: "log: func",
...
fn allowed_worlds(kind: BehaviorKind) -> String {
    HOST_IMPORT_SPECS
        .iter()
